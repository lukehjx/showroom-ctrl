...
INTENT_KEYWORDS = {
    'list_files': ['有哪些文件', '有什么文件', '有哪些内容', '有什么内容', '有哪些资料', '有什么资料', '这里有什么内容', '展示什么内容', '能看什么', '文件列表', '内容列表'],
...
意图列表（只能选其中一个）：
- list_files: 查看/问展厅有哪些文件、展示内容、资料（必须是在问展示内容，不是问其他事情）
  例：有哪些文件 / 有哪些内容 / 这里有什么内容 / 能看什么
